...
#[allow(non_snake_case)]
pub fn set_member_proof_no_opt<R: RngCore, E: Pairing>(
    message: &str,
    sma_crs: &SmaCRS<E>,
    comm: &SmaComm<E>,
    ring: &Vec<E::ScalarField>,
    ...
    <E::ScalarField as FromStr>::Err: Debug,
{
    ...
    *b_exp_values.get_mut(signer_index).unwrap() += r_s;
    ...
    let duration_proof_opt = duration_pi;
    records.insert(
        "Gen proof opt",
        format!(
            "{}.{:09} seconds",
    ...
    SmaProof {
        ...
        c_s_g1: c_s_g1.into(),
        pi: pi.into(),
        c_h_g1: E::G1::generator().into(),
        c_u_g2: E::G2::generator().into(),
        c_t_g2: E::G2::generator().into(),
        pi_kzg: E::G1::generator().into(),
    }
}